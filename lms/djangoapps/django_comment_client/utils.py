...
def get_discussion_category_map(course):
    ...
    cohorted_discussion_ids = course_cohort_settings.cohorted_discussions
    ...
    for topic, entry in course.discussion_topics.items():
        category_map['entries'][topic] = {
            ...
            "is_cohorted": course_cohort_settings.is_cohorted and entry["id"] in cohorted_discussion_ids
        }
