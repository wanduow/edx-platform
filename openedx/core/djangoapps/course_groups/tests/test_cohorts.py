...
from ..tests.helpers import (
    topic_name_to_id, config_course_cohorts, config_course_cohorts_legacy, CohortFactory, CourseCohortFactory, CourseCohortSettingsFactory
)
...
class TestCohorts(ModuleStoreTestCase):
    ...
    def test_update_course_cohort_settings(self):
        ...
        course_cohort_settings = cohorts.set_course_cohort_settings(
            course.id,
            is_cohorted=False,
